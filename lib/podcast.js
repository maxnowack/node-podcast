...
function Podcast (options, items) {
    ...
    this.itunesSummary  = options.itunesSummary;
    this.itunesOwner    = options.itunesOwner; // {name:String, email:String}
    ...
    this.itunesImage    = options.itunesImage;
...
function generateXML (data){
    ...
    ifTruePush(data.itunesOwner.name && data.itunesOwner.email, channel, {'itunes:owner': [{'itunes:name':data.itunesOwner.name},{'itunes:email':data.itunesOwner.email}]);
    ifTruePush(data.itunesCategory, channel, buildiTunesCategories(data.itunesCategory));
